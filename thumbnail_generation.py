...
Image.MAX_IMAGE_PIXELS = 31104000
    ...
    try: 
        ...
        try:
            ...
            with open('big_image_prod.csv', 'a', newline='') as file:
                ...
                writer.writerow([row.id, row.domain_id, e, "Image too big"])
            return None
...
def process_domain(domain):
    ...
    for batch_start in tqdm(range(0, total_records, batch_size)):
        try:
            ...
            #print("batch query:",batch_query.count())
            ...
            #print("len thumbnail data",len(thumbnail_data))
...
if __name__ == "__main__":
    ...
    db_session.close()
    #domains = ["36433986-be88-4707-901d-a27e4dec6de2"]
